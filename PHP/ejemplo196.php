...
$resultado=mysqli_query($c,"SELECT demo5.DNI,demo5.Nombre,demo5.Apellido1, demo5.Apellido2 ,demodat1.Puntos, demodat2.Puntos, demodat3.Puntos FROM demo5, demodat1, demodat2, demodat3 WHERE (demo5.DNI=demodat1.DNI AND demo5.DNI=demodat2.DNI AND demo5.DNI=demodat3.DNI) ORDER BY demodat1.Puntos+demodat2.Puntos+demodat3.Puntos DESC ");
